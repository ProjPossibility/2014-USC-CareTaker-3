...
- (void) initControlView
{
    ...
    [setName setBackgroundColor:[UIColor colorWithRed:0.0f green:0.0f blue:1.0f alpha:1.0f]];
    ...
    nameField = [[UITextField alloc] initWithFrame:CGRectMake(10, 100, 300, 64)];
